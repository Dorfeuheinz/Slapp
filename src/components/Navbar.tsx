  ...
  return (
    <div className="navbar bg-base-100">
      ...
      <AppBar position="static" color="transparent">
        <Toolbar>
        <div className="navbar-start">
        {globalState.LightMode? <img className="logosizing" src={String(blacklogo)} alt="logo"/> : <img className="logosizing" src={String(whitelogo)} alt="logo"/>}
      </div>
          <Search>
            <SearchIconWrapper>
              <SearchIcon />
      ...
      <div onClick={handleToggle} style={{width:"26%",display: "flex", justifyContent: "center", alignItems: "center"}}>
